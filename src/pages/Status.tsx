          ...
          <TabsContent value="basics" className="mt-8">
            <Card className="border-2 border-primary/20 shadow-2xl rounded-[2.5rem] hover:shadow-3xl transition-shadow duration-300">
              ...
              <CardContent className="space-y-4 text-lg leading-relaxed">
                <p>
                  Самозанятый – это физическое лицо или индивидуальный предприниматель (ИП), который платит налог на профессиональный доход.
                  Налог на профессиональный доход (НПД) — это специальный налоговый режим, который можно применять с 2019 года. Он будет действовать до 31 декабря 2028 года.
                </p>
